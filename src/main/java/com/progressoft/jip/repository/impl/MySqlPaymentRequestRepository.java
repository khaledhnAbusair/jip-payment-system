...
public class MySqlPaymentRequestRepository implements PaymentRequestRepository {

    private MySqlPaymentRequestGatway gateway;

    public MySqlPaymentRequestRepository(MySqlPaymentRequestGatway gateway) {
