...
public class MySQLCurrencyGatewayTest {
	...
	currencyGatewaty = new MySqlCurrencyGateway(configuredConnection, new CurrencyGatewayDBBehaviorsFactoryImpl());
	...
	assertNotNull(currencyGatewaty.loadCurrencyByCode("DEL"));
    }
