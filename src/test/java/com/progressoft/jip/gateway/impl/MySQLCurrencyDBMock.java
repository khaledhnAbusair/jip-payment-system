...
public class MySQLCurrencyDBMock {
	...
	try (Connection connection = dataSource.getConnection()) {
	    PreparedStatement statement = connection.prepareStatement("delete from " + Constants.CRNCY_TABLE_NAME
		    + " where CODE = 'UPD'");
	    statement.executeUpdate();
	    PreparedStatement statement2 = connection.prepareStatement("delete from " + Constants.CRNCY_TABLE_NAME
		    + " where CODE = 'DEL'");
